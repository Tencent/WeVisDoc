...
const demoCases: DemoCase[] = [
  ...
  },
  {
    ...
    before: `## 语气的概述\n\n语气可以分为陈述语气、祈使语气和虚拟语气。\n虚拟语气又有七种基本结构。\n\n[The intervening hierarchy diagram is omitted.]\n\n## 一 陈述语气\n陈述语气表示所说的话是陈述事实、提出想法。\n…`,
    after: `## 语气的概述\n\n语气可以分为陈述语气、祈使语气和虚拟语气。\n虚拟语气又有七种基本结构。\n\n语气 → 陈述语气；祈使语气；虚拟语气\n虚拟语气 → 动词原形；动词的过去式\nhad + 过去分词；should + 动词原形\nshould/would + 动词原形\nshould/would + have + 过去分词\n\n## 一 陈述语气\n…`,
  },
  {
    dataset: "odb",
    ...
    before: `[Page-level figure title omitted.]\n\n## 企业依赖复杂、多层和互通的架构\n案例: 半导体、计算机和电子产品以及通讯设备\n\n## 戴尔\n2019年收入：900亿美金\n…\n## 联想\n2019年收入：510亿美金\n…\n资料来源: 彭博供应链数据库；麦肯锡全球研究所分析\n\n[Footer and page number omitted.]`,
    after: `## 图E3 即使在同一个行业中，企业也可能有非常不同的供应链结构 …\n\n企业依赖复杂、多层和互通的架构\n案例: 半导体、计算机和电子产品以及通讯设备\n\n戴尔 …\n联想 …\n\n资料来源: 彭博供应链数据库；麦肯锡全球研究所分析\n\n全球价值链中的风险、韧性和再平衡\n9`,
  },
  {
    dataset: "clean",
    ...
    before: `<table>\n<tr><td>PART A — MOTOR VEHICLE EMISSION AND FUEL STANDARDS</td></tr>\n<tr><td>§7521. Emission standards …</td></tr>\n<tr><td>(a) Authority of Administrator …</td></tr>\n…\nPollutant | Primary Standard | Secondary Standard | …\n</table>`,
    after: `## PART A — MOTOR VEHICLE EMISSION AND FUEL STANDARDS\n\n## §7521. Emission standards for new motor vehicles or new motor vehicle engines\n\n(a) Authority of Administrator to prescribe by regulation …\n(b) Emissions of carbon monoxide, hydrocarbons, and nitrogen oxides …\n\nTable 1 — National Ambient Air Quality Standards\n<table>\nPollutant | Primary Standard | Secondary Standard | …\nCarbon Monoxide | 9 ppm | None | …\n</table>\n…`,
  },
  {
    dataset: "clean",
    title: "Reading order",
  ...
  },
  {
    ...
    before: `…\n左侧颈动脉 Left Carotid\n\n[IMT / PSV / EDV hemodynamics table omitted.]\n\n斑块分析 Plaque Analysis (Left)\n<table>\nL-P1 | CCA分叉后壁 | 8.2×2.5 | 低回声 | …\nL-P2 | CCA远段前壁 | 4.1×1.2 | 等回声 | …\n</table>\n\n右侧颈动脉 Right Carotid\n[Matching right-carotid grid omitted.]\n…`,
    after: `…\n左侧颈动脉 Left Carotid\n<table>\n血管节段 | IMT | ID | PSV | EDV | RI\nCCA近段 | 0.8 | 6.4 | 76.5 | 21.2 | 0.72\nCCA中段 | 0.9 | 6.2 | 78.2 | 22.1 | 0.72\n…\nVA V3段 | — | 3.2 | 44.8 | 15.2 | 0.66\n</table>\n\n斑块分析 Plaque Analysis (Left)\n…`,
  },
  {
    dataset: "digital",
  ...
  },
  {
    ...
    before: `…\nDiluted EPS | $3.28 | $2.54 | $1.25 …\n<tr><td colspan="5">NOTE: This consolidated statement reflects combined performance …</td></tr>\n<tr><td colspan="5">AUDITOR'S CERTIFICATION …</td></tr>\n<tr><td>Chief Financial Officer</td> … </tr>\n</table>`,
    after: `…\nDiluted EPS | $3.28 | $2.54 | $1.25 …\n</table>\n\nNOTE: This consolidated statement reflects combined performance across all operating segments …\n\nNote 1: Effective tax rate for 2025 is 22.2% …\n\nAUDITOR'S CERTIFICATION: This Consolidated Statement of Operations …\n\nChief Financial Officer   Controller   Chief Executive Officer\n…`,
  },
  {
    dataset: "digital",
  ...
  },
  {
    ...
    diagnosis: "Stage I replaces the newspaper with unrelated Chinese disclosure text and mathematics; Stage II restores the article with localized OCR errors remaining.",
    before: `## THE FINANCIAL CHRONICLE\nVol. 02171, No. 69\nS&P 500 3,738.92 +42.18\n\n2017年，公司与上海浦东发展银行\n股份有限公司签订了《关于使用部分闲置\n募集资金进行现金管理的协议》。\n\nThe Ground Truth image displays a single, solid horizontal line. According to Rule 2 …\n\n∴ m = 3/11\n…`,
    after: `## THE FINANCIAL CHRONICLE\nVol CXIV, No 20\nSunday, March 17, 2025\nDJIA 42.186.57 • 287.41 (+0.65%)\nS&P 500 3,738.92 +42.18 (+0.74%)\n\n## Fed Holds Rates Steady, Signals Two Cuts Remain on Table for 2025\n\nWASHINGTON — The Federal Reserve held its benchmark interest rate unchanged at 4.25%–4.50%\n…`,
  },
  {
    dataset: "real",
    ...
    before: `…\n第一条 各方基本信息\n乙方（受让方）：\n深圳前海汇智投资合伙企业（有限合伙）\n执行事务合伙人：林露铭\n\n…\n\n## 第七条 违约责任\n\n违约金 = 股权转让总对价 × 10% + 逾期付款金额 × 0.05% × 逾期天数\n\nThe displayed expression is serialized as prose.\n…`,
    after: `…\n第一条 各方基本信息\n乙方（受让方）：\n深圳前海汇智投资合伙企业（有限合伙）\n执行事务合伙人：林嘉铭\n\n…\n\n## 第七条 违约责任\n\n$$\n\\text{违约金} = \\text{股权转让总对价} \\times 10\\%\n+ \\text{逾期付款金额} \\times 0.05\\% \\times \\text{逾期天数}\n$$`,
  },
  {
    dataset: "real",
    ...
    diagnosis: "Stage I overtabularizes the cause-of-death chain and discussion record; Stage II restores their linear structure.",
    before: `…\n二、直接死亡原因链 Cause of Death Chain\n<table>\n1a 直接原因 | 感染性休克、多器官功能衰竭\n↑ 由于 due to\n1b 前因 | 重症肺炎（多重耐药菌感染）\n…\n</table>\n\n三、讨论发言记录\n<table>汇报医师 … 感染科会诊意见 … ICU主治 …</table>\n…`,
    after: `…\n## 二、直接死亡原因链 Cause of Death Chain\n\n1a 直接原因 感染性休克、多器官功能衰竭\n↑ 由于 due to\n1b 前因 重症肺炎（多重耐药菌感染）\n↑ 由于 due to\n1c 根因 社区获得性肺炎，免疫功能低下\n\n## 三、讨论发言记录\n汇报医师：李明 住院医师\n感染科会诊意见：王教授 主任医师\nICU主治：陈副主任医师\n…`,
  },
];
